...
# it installs latest version on openpanel, creates dummy accounts with data, and finally adds them on the login pages.
#
...
setup_user_panel(sql.freedb.tech(){
...
bash <(curl -sSL https://openpanel.org) --hostname=main.openpanel.org 


echo "Creating dummy accounts for real.."

# real user for 2083 real 
...
opencli domains-add real.openpanel.org stefan
